#!/usr/bin/env python3
"""
Test script for the Pythia-8 simulation module.
This script tests the module without requiring Pythia-8 installation.
"""
...
from qad.simulation.config_parser import SimulationConfig, PhysicsProcess, SimulationSettings, JetSettings
